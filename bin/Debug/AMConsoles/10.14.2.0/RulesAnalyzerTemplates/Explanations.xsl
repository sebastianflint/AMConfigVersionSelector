    ...
    <table>
      <tr>
        ...
        <xsl:choose>
          ...
          <xsl:when test="@name = 'AADUser'">
            <xsl:value-of select="$explanationof" />&#160;<xsl:value-of select="$aaduser"/>
          </xsl:when>
          <xsl:when test="@name = 'AADGroup'">
            <xsl:value-of select="$explanationof" />&#160;<xsl:value-of select="$aadgroup"/>
          </xsl:when>
