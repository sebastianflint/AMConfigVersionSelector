...
$vhdType = [EMConfigAPI.Actions.Vhd+ConfigAPIVhdTypes]::Fixed
$vhdUnit = [EMConfigAPI.Actions.Vhd+ConfigAPIVhdUnits]::GB
[Void] $config.AddActionOrCondition($vhdActionId, (New-Object EMConfigAPI.Actions.Vhd("C:\Test.vhd", "C:\WorkingDirectory\", $true, $vhdType, "1.5", $vhdUnit, $true, $false, $true)))
...
[void] $config.AddReusableCondition($preDesktopConditions,$reusableConditionNodeId)
...
$clientColourDepthpId = $config.AddNodeToParent($preDesktopConditions,"Client Colour Depth")
[Void] $config.AddActionOrCondition($clientColourDepthpId, (New-Object EMConfigAPI.Conditions.ClientScreenColorDepth("Equal","Colors16M")))
...
$clientIPAddressObject2 = new-object EMConfigAPI.Generic.ActionBase("UEM.Condition.ClientIPAddress", [UEM.Helpers.ActionTypeFlags]::ConditionalClient)
...
# --- ComputerGroup condition ---
write "ComputerGroup condition"
...
[void] $config.AddActionOrCondition($vmWareNodeId, (New-Object EMConfigAPI.Actions.Comment("VMWare variable - Set the broker URL")))
[Void] $config.AddActionOrCondition($vmWareNodeId, $vmWareVariables)
